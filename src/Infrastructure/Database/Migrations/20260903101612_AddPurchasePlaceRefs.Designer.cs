...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20260903101612_AddPurchasePlaceRefs")]
    partial class AddPurchasePlaceRefs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Beneficiaries.Beneficiary", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.GoldAcquisitions.GoldAcquisition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("PurchasePlaceId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PurchasePlaceId");

                    b.HasIndex("UserId");

                    b.ToTable("gold_acquisitions", (string)null);
                });

            modelBuilder.Entity("Domain.GoldTypes.GoldType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("gold_types", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.PurchasePlaces.PurchasePlace", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("purchase_places", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.GoldAcquisitions.GoldAcquisition", b =>
                {
                    ...
                    b.HasOne("Domain.PurchasePlaces.PurchasePlace", null)
                        .WithMany()
                        .HasForeignKey("PurchasePlaceId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Transactions.Transaction", b =>
                {
                    b.HasOne("Domain.Beneficiaries.Beneficiary", null)
                        .WithMany()
